...
import { weatherIcons, WeatherIconsKeysProps, WeatherIconProps } from '.';
...
describe('weatherIcons', () => {
  it('should have all weather conditions', () => {
    const expectedKeys: WeatherIconsKeysProps[] = [
      'Clouds',
      'Rain',
      'Clear',
      'Snow',
    ];
    expect(Object.keys(weatherIcons)).toEqual(
      expect.arrayContaining(expectedKeys)
    );
  });

  it('should have correct details for Clouds', () => {
    const details: WeatherIconProps = {
      name: 'Nuvens',
      bg_day: bgCloudyDay,
    ...
    expect(weatherIcons['Clouds']).toEqual(details);
  });

  it('should have correct details for Rain', () => {
    const details: WeatherIconProps = {
      name: 'Chuva',
      bg_day: bgRainDay,
    ...
    expect(weatherIcons['Rain']).toEqual(details);
  });

  it('should have correct details for Clear', () => {
    const details: WeatherIconProps = {
      name: 'Limpo',
      bg_day: bgClearDay,
    ...
    expect(weatherIcons['Clear']).toEqual(details);
  });

  it('should have correct details for Snow', () => {
    const details: WeatherIconProps = {
      name: 'Neve',
      bg_day: bgSnowDay,
    ...
    expect(weatherIcons['Snow']).toEqual(details);
  });
});
