...
interface WeatherIcons {
  Clouds: WeatherIconDetails;
  Rain: WeatherIconDetails;
  Clear: WeatherIconDetails;
  Snow: WeatherIconDetails;
}
...
export type WeatherIconProps = (typeof weatherIcons)[WeatherIconsKeysProps];
